...
class QuestionFormInputTemplate extends StatefulWidget {
  ...
  @override
  State<QuestionFormInputTemplate> createState() =>
      _QuestionFormInputTemplateState();
}

class _QuestionFormInputTemplateState extends State<QuestionFormInputTemplate> {
                  ...
                  child: Column(
                    ...
                    children: [
                      Row(
                        children: [
                          Text(
                            "${widget.question.question.indexOf(widget.question.question) + 1}.",
                            style:
